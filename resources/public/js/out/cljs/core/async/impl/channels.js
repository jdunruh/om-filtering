...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13743 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13743 = (function (val,box,meta13744){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13743.cljs$lang$type = true;
cljs.core.async.impl.channels.t13743.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13743";
cljs.core.async.impl.channels.t13743.cljs$lang$ctorPrWriter = (function (this__4162__auto__,writer__4163__auto__,opt__4164__auto__){return cljs.core._write.call(null,writer__4163__auto__,"cljs.core.async.impl.channels/t13743");
});
cljs.core.async.impl.channels.t13743.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13743.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13745){var self__ = this;
var _13745__$1 = this;return self__.meta13744;
});
cljs.core.async.impl.channels.t13743.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13745,meta13744__$1){var self__ = this;
var _13745__$1 = this;return (new cljs.core.async.impl.channels.t13743(self__.val,self__.box,meta13744__$1));
});
cljs.core.async.impl.channels.__GT_t13743 = (function __GT_t13743(val__$1,box__$1,meta13744){return (new cljs.core.async.impl.channels.t13743(val__$1,box__$1,meta13744));
});
}
return (new cljs.core.async.impl.channels.t13743(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4165__auto__,writer__4166__auto__,opts__4167__auto__){return cljs.core._write.call(null,writer__4166__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4162__auto__,writer__4163__auto__,opt__4164__auto__){return cljs.core._write.call(null,writer__4163__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13746 = self__.takes.pop();if((taker_13746 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13746))
{var take_cb_13747 = cljs.core.async.impl.protocols.commit.call(null,taker_13746);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13747,taker_13746,this$__$1){
return (function (){return take_cb_13747.call(null,null);
});})(take_cb_13747,taker_13746,this$__$1))
);
} else
{}
{
