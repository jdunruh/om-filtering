...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13737 = (0);while(true){
var m_13738 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13738 == null))
{} else
{m_13738.call(null);
if((count_13737 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13739 = (count_13737 + (1));
count_13737 = G__13739;
continue;
}
} else
{}
